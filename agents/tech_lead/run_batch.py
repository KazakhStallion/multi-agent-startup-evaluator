...
DATASET_PATH = PROJECT_ROOT / "data" / "tech_lead" / "tech_cases_clean.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Technical Lead agent over tech_cases_clean.json")
    parser.add_argument(
        "--dataset",
        type=Path,
        default=DATASET_PATH,
        help="Path to tech lead dataset JSON",
    )
